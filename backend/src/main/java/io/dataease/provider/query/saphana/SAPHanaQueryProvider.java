...
import io.dataease.dto.datasource.SapHanaConfiguration;
 ...
 */
@Service("saphanaQuery")
public class SAPHanaQueryProvider extends QueryProvider {
    ...
    public String createQuerySQL(String table, List<DatasetTableField> fields, boolean isGroup, Datasource ds, List<ChartFieldCustomFilterDTO> fieldCustomFilter) {
        SQLObj tableObj = SQLObj.builder()
                .tableName((table.startsWith("(") && table.endsWith(")")) ? table : String.format(SAPHanaConstants.KEYWORD_TABLE, table))
                .tableAlias(String.format(SAPHanaConstants.ALIAS_FIX, String.format(TABLE_ALIAS_PREFIX, 0)))
                .build();
    ...
    public void setSchema(SQLObj tableObj, Datasource ds) {
        if (ds != null && !tableObj.getTableName().startsWith("(") && !tableObj.getTableName().endsWith(")")) {
            ...
            schema = String.format(SAPHanaConstants.KEYWORD_TABLE, schema);
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
                    ...
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                } else {
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                }
                String fieldAlias = String.format(SAPHanaConstants.ALIAS_FIX, String.format(SQLConstants.FIELD_ALIAS_X_PREFIX, i));
                String fieldName = "";
                // 处理横轴字段
                if (f.getDeExtractType() == 1) {
                    if (f.getDeType() == 2 || f.getDeType() == 3) {
                        fieldName = String.format(SAPHanaConstants.UNIX_TIMESTAMP, originField) + "*1000";
                    } else {
                        fieldName = originField;
                    }
                } else if (f.getDeExtractType() == 0) {
                    if (f.getDeType() == 2) {
                        fieldName = String.format(SAPHanaConstants.CAST, originField, SAPHanaConstants.DEFAULT_INT_FORMAT);
                    } else if (f.getDeType() == 3) {
                        fieldName = String.format(SAPHanaConstants.CAST, originField, SAPHanaConstants.DEFAULT_FLOAT_FORMAT);
                    } else if (f.getDeType() == 1) {
                        fieldName = String.format(SAPHanaConstants.DATE_FORMAT, originField, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    } else {
                        fieldName = originField;
                    }
                } else {
                    if (f.getDeType() == 1) {
                        String cast = String.format(SAPHanaConstants.CAST, originField, SAPHanaConstants.DEFAULT_INT_FORMAT) + "/1000";
                        fieldName = String.format(SAPHanaConstants.FROM_UNIXTIME, cast, SAPHanaConstants.DEFAULT_DATE_FORMAT);
    ...
    public String getSQL(String table, List<ChartViewFieldDTO> xAxis, List<ChartViewFieldDTO> yAxis, List<ChartFieldCustomFilterDTO> fieldCustomFilter, List<ChartExtFilterRequest> extFilterRequestList, Datasource ds, ChartViewWithBLOBs view) {
        ...
        if (CollectionUtils.isNotEmpty(xAxis)) {
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName());
                } else {
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName());
                }
                String fieldAlias = String.format(SAPHanaConstants.ALIAS_FIX, String.format(SQLConstants.FIELD_ALIAS_X_PREFIX, i));
        ...
        if (CollectionUtils.isNotEmpty(yAxis)) {
            for (int i = 0; i < yAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(y.getExtField()) && y.getExtField() == 2) {
                    ...
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getOriginName());
                } else {
                    originField = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getOriginName());
                }
                String fieldAlias = String.format(SAPHanaConstants.ALIAS_FIX, String.format(SQLConstants.FIELD_ALIAS_Y_PREFIX, i));
                // 处理纵轴字段
        ...
        SQLObj tableSQL = SQLObj.builder()
                .tableName(String.format(SAPHanaConstants.BRACKETS, sql))
    ...
    public String searchTable(String table) {
        return "SELECT table_name FROM PUBLIC.TABLES WHERE table_name ='" + table + "'";
    }
    ...
    public String createRawQuerySQL(String table, List<DatasetTableField> fields, Datasource ds) {
        ...
        SapHanaConfiguration SapHanaConfiguration = new Gson().fromJson(ds.getConfiguration(), SapHanaConfiguration.class);
        return MessageFormat.format("SELECT {0} FROM {1}", StringUtils.join(array, ","), SapHanaConfiguration.getSchema() + ".\"" + table + "\"");
    }
    ...
    public String convertTableToSql(String tableName, Datasource ds) {
        String schema = new Gson().fromJson(ds.getConfiguration(), JdbcConfiguration.class).getSchema();
        schema = String.format(SAPHanaConstants.KEYWORD_TABLE, schema);
        return createSQLPreview("SELECT * FROM " + schema + "." + String.format(SAPHanaConstants.KEYWORD_TABLE, tableName), null);
    }
    ...
    public String transCustomFilterList(SQLObj tableObj, List<ChartFieldCustomFilterDTO> requestList) {
        ...
        for (ChartFieldCustomFilterDTO request : requestList) {
            ...
            if (ObjectUtils.isNotEmpty(field.getExtField()) && field.getExtField() == 2) {
                ...
                originName = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
            } else {
                originName = String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
            }
            ...
            if (field.getDeType() == 1) {
                if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5) {
                    whereName = String.format(SAPHanaConstants.TO_DATE, originName, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                }
                if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                    String cast = String.format(SAPHanaConstants.CAST, originName, SAPHanaConstants.DEFAULT_INT_FORMAT) + "/1000";
                    whereName = String.format(SAPHanaConstants.FROM_UNIXTIME, cast, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                }
                ...
                if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5) {
                    whereName = String.format(SAPHanaConstants.CAST, originName, SAPHanaConstants.DEFAULT_FLOAT_FORMAT);
                }
                if (field.getDeExtractType() == 1) {
                    whereName = String.format(SAPHanaConstants.UNIX_TIMESTAMP, originName) + "*1000";
                }
                if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                    whereName = originName;
                }
            ...
            if (StringUtils.equalsIgnoreCase(request.getFilterType(), "enum")) {
                ...
                for (ChartCustomFilterItemDTO filterItemDTO : filter) {
                    ...
                    if (StringUtils.equalsIgnoreCase(filterItemDTO.getTerm(), "null")) {
                        ...
                        if (field.getDeType() == 1) {
                            whereValue = String.format(SAPHanaConstants.TO_DATE, "'" + value + "'", SAPHanaConstants.DEFAULT_DATE_FORMAT);
                        } else {
                            whereValue = String.format(SAPHanaConstants.WHERE_VALUE_VALUE, value);
                        }
                    }
        ...
        for (ChartExtFilterRequest request : requestList) {
            ...
            if (StringUtils.containsIgnoreCase(request.getOperator(), "in")) {
                ...
                if (request.getDatasetTableField().getDeType() == 1) {
                    ...
                    String st = String.format(SAPHanaConstants.TO_DATE, "'" + startTime + "'", SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    String et = String.format(SAPHanaConstants.TO_DATE, "'" + endTime + "'", SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    whereValue = st + " AND " + et;
                } else {
                    whereValue = String.format(SAPHanaConstants.WHERE_BETWEEN, value.get(0), value.get(1));
                }
            } else {
                whereValue = String.format(SAPHanaConstants.WHERE_VALUE_VALUE, value.get(0));
            }
            list.add(SQLObj.builder()
                    .whereField(whereName)
                    .whereTermAndValue(whereTerm + whereValue)
    ...
    private String transDateFormat(String dateStyle, String datePattern) {
        ...
        if (StringUtils.isEmpty(dateStyle)) {
            return SAPHanaConstants.DEFAULT_DATE_FORMAT;
        }
        ...
        if (x.getDeExtractType() == TIME) {
            if (x.getDeType() == INT || x.getDeType() == FLOAT) { //时间转数值
                if (x.getType().equalsIgnoreCase("DATE")) {
                    String date = String.format(SAPHanaConstants.CALC_SUB, originField, String.format(SAPHanaConstants.TO_DATE, SAPHanaConstants.DEFAULT_START_DATE, SAPHanaConstants.DEFAULT_DATE_FORMAT));
                    fieldName = String.format(SAPHanaConstants.TO_NUMBER, date) + SAPHanaConstants.TO_MS;
                } else {
                    String toChar = String.format(SAPHanaConstants.TO_CHAR, originField, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    String toDate = String.format(SAPHanaConstants.TO_DATE, toChar, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    String toDate1 = String.format(SAPHanaConstants.TO_DATE, SAPHanaConstants.DEFAULT_START_DATE, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    fieldName = String.format(SAPHanaConstants.TO_NUMBER, String.format(SAPHanaConstants.CALC_SUB, toDate, toDate1)) + SAPHanaConstants.TO_MS;
                }
            } else if (x.getDeType() == TIME) { //格式化显示时间
                String format = transDateFormat(x.getDateStyle(), x.getDatePattern());
                if (x.getType().equalsIgnoreCase("DATE")) {
                    fieldName = String.format(SAPHanaConstants.TO_CHAR, originField, format);
                } else {
                    String toChar = String.format(SAPHanaConstants.TO_CHAR, originField, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    String toDate = String.format(SAPHanaConstants.TO_DATE, toChar, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    fieldName = String.format(SAPHanaConstants.TO_CHAR, toDate, format);
                }
            } else {
                fieldName = originField;
            }
            ...
            if (x.getDeType() == TIME) {
                ...
                if (x.getDeExtractType() == STRING) { //字符串转时间
                    String toDate = String.format(SAPHanaConstants.TO_DATE, originField, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    fieldName = String.format(SAPHanaConstants.TO_CHAR, toDate, format);
                } else {                            //数值转时间
                    String date = originField + "/(1000 * 60 * 60 * 24)+" + String.format(SAPHanaConstants.TO_DATE, SAPHanaConstants.DEFAULT_START_DATE, SAPHanaConstants.DEFAULT_DATE_FORMAT);
                    fieldName = String.format(SAPHanaConstants.TO_CHAR, date, format);
                }
            } else {
                fieldName = originField;
            }
        ...
        if (CollectionUtils.isNotEmpty(x.getFilter()) && x.getFilter().size() > 0) {
            x.getFilter().forEach(f -> {
                ...
                if (StringUtils.equalsIgnoreCase(f.getTerm(), "null")) {
                    ...
                    whereValue = String.format(SAPHanaConstants.WHERE_VALUE_VALUE, f.getValue());
                }
                list.add(SQLObj.builder()
                        .whereField(whereName)
    ...
    private SQLObj getYFields(ChartViewFieldDTO y, String originField, String fieldAlias) {
        ...
        if (StringUtils.equalsIgnoreCase(y.getOriginName(), "*")) {
            fieldName = SAPHanaConstants.AGG_COUNT;
        } else if (SQLConstants.DIMENSION_TYPE.contains(y.getDeType())) {
            fieldName = String.format(SAPHanaConstants.AGG_FIELD, y.getSummary(), originField);
        } else {
            if (StringUtils.equalsIgnoreCase(y.getSummary(), "avg") || StringUtils.containsIgnoreCase(y.getSummary(), "pop")) {
                String cast = String.format(SAPHanaConstants.CAST, originField, y.getDeType() == 2 ? SAPHanaConstants.DEFAULT_INT_FORMAT : SAPHanaConstants.DEFAULT_FLOAT_FORMAT);
                String agg = String.format(SAPHanaConstants.AGG_FIELD, y.getSummary(), cast);
                fieldName = String.format(SAPHanaConstants.CAST, agg, SAPHanaConstants.DEFAULT_FLOAT_FORMAT);
            } else {
                String cast = String.format(SAPHanaConstants.CAST, originField, y.getDeType() == 2 ? SAPHanaConstants.DEFAULT_INT_FORMAT : SAPHanaConstants.DEFAULT_FLOAT_FORMAT);
                fieldName = String.format(SAPHanaConstants.AGG_FIELD, y.getSummary(), cast);
            }
        }
        return SQLObj.builder()
                .fieldName(fieldName)
    ...
    private String calcFieldRegex(String originField, SQLObj tableObj) {
        ...
        for (DatasetTableField ele : calcFields) {
            originField = originField.replaceAll("\\[" + ele.getId() + "]",
                    String.format(SAPHanaConstants.KEYWORD_FIX, tableObj.getTableAlias(), ele.getOriginName()));
        }
        return originField;
    }
